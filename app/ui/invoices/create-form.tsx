...
export default function Form({ customers }: { customers: CustomerField[] }) { 
  ...
  // the input element of html always return a string.
  return (
    // Behind the scenes, Server Actions create a POST API endpoint.
    // to submit this form and to handle this POST request, i need to create an api route. But this can be done by server actions.
